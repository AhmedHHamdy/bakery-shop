export default function Page() {
  return (
    <>
      <main className="h-screen grid grid-cols-3 md:grid-cols-6 xl:grid-cols-9 xl:grid-rows-2">
      ...
      <section className="learn-more-section grid grid-cols-4">
        ...
        <section className="bg-Lemon_Zest border-r-8 border-b-8 p-4 col-span-2 xl:flex xl:flex-col xl:items-start xl:justify-center xl:p-20 xl:gap-10">
          ...
          <p className="text-sm font-semibold xl:text-xl">
            At Cupcaked, we believe in the importance of delivering pure joy
          ...
          <a className="text-sm font-semibold underline xl:text-base" href="">Learn More</a>
        </section>
      </section>
      ...
      <section className="flex flex-col xl:grid xl:grid-cols-4 xl:grid-rows-2">
        ...
        <div className="hidden xl:grid xl:grid-cols-6 xl:col-span-2 w-full xl:row-span-2">
          <div className="xl:col-span-3 xl:col-start-1 xl:w-full xl:h-60">
          ...
          <div className="xl:col-span-3 xl:col-start-4 xl:w-full xl:h-60 xl:row-start-1">
          ...
          <div className="xl:col-span-3 xl:col-start-1 xl:row-start-3 xl:h-60">
          ...
          <div className="xl:col-span-3 xl:col-start-4 xl:row-start-3 xl:h-60">
